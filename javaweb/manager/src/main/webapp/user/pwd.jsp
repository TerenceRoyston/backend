...
<div class="formbody">
    ...
    <form action="user" method="post" id="fm" target="_top">
        ...
        <ul class="forminfo">
            ...
            <li><label>确认新密码</label><input name="" id="cfPwd" type="text" class="dfinput" /><i></i></li>
            <li><label></label><button name="" type="submit" class="btn" value="确认保存" style="background-color: #ec821b;width: 76px;height: 36px;color: #ffffff">确认保存</button></li>
        </ul>
    </form>
